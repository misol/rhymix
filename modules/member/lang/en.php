...
$lang->msg_mail_authorization = 'The webmaster\'s name and email address should be valid in order to use the email verification function.';
$lang->column_id = 'The column id';
$lang->about_column_id = 'The ID that will be used as a delimiter for the entry. Its first character should be the alphabet, which only alphanumeric characters should follow.';
$lang->options = 'Options';
$lang->about_keep_signed = 'You will be still logged in even after the browser is closed.\\n\\nIt is not recommended to use this if you are using a public computer, for your personal information can be violated.';
$lang->about_keep_warning = 'You will be still logged in even after the browser is closed. It is not recommended to use this if you are using a public computer, for your personal information can be violated';
...
$lang->about_group = 'A single ID can belong to multiple groups.';
